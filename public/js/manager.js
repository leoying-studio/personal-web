...
$(document).ready(function () {
    ...
    $("#panelWrapper").kendoPanelBar({
        ...
        select: function (e) {
            ...
            var itemType = panelItem.getAttribute("panel-item-type");
            if (itemType == "0") {
                var categories = JSON.parse(panelItem.getAttribute("categories"));
                var fields = [
                ...
                var navId = panelItem.getAttribute("navId");
                var categoryId = panelItem.getAttribute("categoryId");
    ...
    $("#article-detail-content").kendoEditor({
        resizable: {
            content: true,
            toolbar: false
        },
