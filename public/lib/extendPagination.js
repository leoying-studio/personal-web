...
(function ($) {
    $.fn.extendPagination = function (options) {
        ...
        if (totalPage > 0) {
            ...
            html.push(' <li class="previous page-item"><a href="#" class="page-link">&laquo;</a></li>');
            html.push('<li class="disabled hidden page-item"><a href="#" class="page-link">...</a></li>');
            if (totalPage <= showPage) {
                for (var i = 1; i <= totalPage; i++) {
                    if (i == 1) html.push(' <li class="active"><a href="#" class="page-link">' + i + '</a></li>');
                    else html.push(' <li class="page-item"><a href="#" class="page-link">' + i + '</a></li>');
                }
            } else {
                for (var j = 1; j <= showPage; j++) {
                    if (j == 1) html.push(' <li class="active page-item"><a href="#" class="page-link">' + j + '</a></li>');
                    else html.push(' <li class="page-item"><a href="#" class="page-link">' + j + '</a></li>');
                }
            }
            html.push('<li class="page-item disabled hidden "><a href="#" class="page-link">...</a></li>');
            html.push('<li class="page-item next"><a href="#" class="page-link">&raquo;</a></li></ul>');
            $(this).html(html.join(''));
